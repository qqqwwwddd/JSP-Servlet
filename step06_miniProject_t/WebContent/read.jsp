...
<table align="center" cellpadding="5" cellspacing="2" width="600" border='1'>
    <tr>
        <td width="1220" height="20" colspan="4" bgcolor="salmon">
    ...
    <tr>
        <td width="100" height="20" >
            <p align="center"><b><span style="font-size:9pt;">작성일</span></b></p>
        </td>
        <td width="300" height="20" "><span style="font-size:9pt;"><b>
		${requestScope.resultContent.writeday}</b></span></td>
        <td width="100" height="20" >
                <p align="center"><b><span style="font-size:9pt;">조회수</span></b></p>
		</td>
        <td width="100" height="20">
    ...
    <tr>
        <td width="100" height="20">
            <p align="center"><b><span style="font-size:9pt;">제 목</span></b></p>
        </td>
        <td width="450" height="20" colspan="3"><span style="font-size:9pt;"><b>
